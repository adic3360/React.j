            ...
            <div key={group} className="group col-sm-2">
              ...
              <div className="group-header mb-3 d-flex justify-content-between">
                <div className="group-title d-flex">
                  ...
                  { groupingOption === "priority" && (
                    <div className="d-flex ps-1">
                      <img src={getPriorityImgPath(group)} alt="" className="me-2" width="30px"/>
                      <h6>{priority[group]}</h6>
                    </div>
                  ) }
                  <span className="ps-2 pb-1 align-self-center text-muted">{groupedAndSortedTickets[group].length}</span>
                </div>
